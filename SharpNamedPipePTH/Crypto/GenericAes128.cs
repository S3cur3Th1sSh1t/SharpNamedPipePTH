...
using System.Text;
using SharpNamedPipePTH.Win32;

namespace SharpNamedPipePTH.Crypto
{
    class GenericAes128
    {
        ...
        public static bool kull_m_crypto_genericAES128Decrypt(IntPtr pKey, IntPtr pIV, IntPtr pData, uint dwDataLen, ref IntPtr pOut, ref uint dwOutLen)
        {
            ...
            if (SharpNamedPipePTH.Win32.Natives.CryptAcquireContextA(ref hProv, null, null, PROV_RSA_AES, CRYPT_VERIFYCONTEXT))
            {
